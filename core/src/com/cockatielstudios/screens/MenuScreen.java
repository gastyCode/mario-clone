...
public class MenuScreen implements Screen {
    ...
    public MenuScreen(MainGame game) {
        ...
        this.startButton = new Button("Start", Assets.manager.get(Assets.arcadeclassic), new Vector2(0, 0));
        this.quitButton = new Button("Quit", Assets.manager.get(Assets.arcadeclassic), new Vector2(this.camera.position.x, 20));
    }
