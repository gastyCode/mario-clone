...
/**
 * Trieda, ktorá dedí z triedy GameObject, potrebná na vytvorenie prekážky.
 */
public class Pipe extends GameObject {
    /**
     * Konštruktor, ktorý nastavuje atributy prekážky.
     *
     * @param screen Inštancia tiredy GameScreen, ktorá vykresľuje samotnú hru.
     * @param position Pozícia prekážky.
     * @param width Šírka prekážky.
     * @param height Výška prekážky.
     */
